...
body <- dashboardBody(
  tabItems(
    ...
    tabItem(tabName = "sys71",
      h3(cda_system$Indikator[14]), radioButtons("org71q01", label = h4(cda_system$Pertanyaan[14]), choiceNames = list(as.character(cda_system$L1[14]), as.character(cda_system$L2[14]), as.character(cda_system$L3[14]), as.character(cda_system$L4[14]), as.character(cda_system$L5[14])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[15]), radioButtons("org71q02", label = h4(cda_system$Pertanyaan[15]), choiceNames = list(as.character(cda_system$L1[15]), as.character(cda_system$L2[15]), as.character(cda_system$L3[15]), as.character(cda_system$L4[15]), as.character(cda_system$L5[15])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[16]), radioButtons("org71q03", label = h4(cda_system$Pertanyaan[16]), choiceNames = list(as.character(cda_system$L1[16]), as.character(cda_system$L2[16]), as.character(cda_system$L3[16]), as.character(cda_system$L4[16]), as.character(cda_system$L5[16])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[17]), radioButtons("org71q04", label = h4(cda_system$Pertanyaan[17]), choiceNames = list(as.character(cda_system$L1[17]), as.character(cda_system$L2[17]), as.character(cda_system$L3[17]), as.character(cda_system$L4[17]), as.character(cda_system$L5[17])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[18]), radioButtons("org71q05", label = h4(cda_system$Pertanyaan[18]), choiceNames = list(as.character(cda_system$L1[18]), as.character(cda_system$L2[18]), as.character(cda_system$L3[18]), as.character(cda_system$L4[18]), as.character(cda_system$L5[18])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[19]), radioButtons("org71q06", label = h4(cda_system$Pertanyaan[19]), choiceNames = list(as.character(cda_system$L1[19]), as.character(cda_system$L2[19]), as.character(cda_system$L3[19]), as.character(cda_system$L4[19]), as.character(cda_system$L5[19])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[20]), radioButtons("org71q07", label = h4(cda_system$Pertanyaan[20]), choiceNames = list(as.character(cda_system$L1[20]), as.character(cda_system$L2[20]), as.character(cda_system$L3[20]), as.character(cda_system$L4[20]), as.character(cda_system$L5[20])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[21]), radioButtons("org71q08", label = h4(cda_system$Pertanyaan[21]), choiceNames = list(as.character(cda_system$L1[21]), as.character(cda_system$L2[21]), as.character(cda_system$L3[21]), as.character(cda_system$L4[21]), as.character(cda_system$L5[21])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[22]), radioButtons("org71q09", label = h4(cda_system$Pertanyaan[22]), choiceNames = list(as.character(cda_system$L1[22]), as.character(cda_system$L2[22]), as.character(cda_system$L3[22]), as.character(cda_system$L4[22]), as.character(cda_system$L5[22])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[23]), radioButtons("org71q10", label = h4(cda_system$Pertanyaan[23]), choiceNames = list(as.character(cda_system$L1[23]), as.character(cda_system$L2[23]), as.character(cda_system$L3[23]), as.character(cda_system$L4[23]), as.character(cda_system$L5[23])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[24]), radioButtons("org71q11", label = h4(cda_system$Pertanyaan[24]), choiceNames = list(as.character(cda_system$L1[24]), as.character(cda_system$L2[24]), as.character(cda_system$L3[24]), as.character(cda_system$L4[24]), as.character(cda_system$L5[24])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[25]), radioButtons("org71q12", label = h4(cda_system$Pertanyaan[25]), choiceNames = list(as.character(cda_system$L1[25]), as.character(cda_system$L2[25]), as.character(cda_system$L3[25]), as.character(cda_system$L4[25]), as.character(cda_system$L5[25])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[26]), radioButtons("org71q13", label = h4(cda_system$Pertanyaan[26]), choiceNames = list(as.character(cda_system$L1[26]), as.character(cda_system$L2[26]), as.character(cda_system$L3[26]), as.character(cda_system$L4[26]), as.character(cda_system$L5[26])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[27]), radioButtons("org71q14", label = h4(cda_system$Pertanyaan[27]), choiceNames = list(as.character(cda_system$L1[27]), as.character(cda_system$L2[27]), as.character(cda_system$L3[27]), as.character(cda_system$L4[27]), as.character(cda_system$L5[27])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[28]), radioButtons("org71q15", label = h4(cda_system$Pertanyaan[28]), choiceNames = list(as.character(cda_system$L1[28]), as.character(cda_system$L2[28]), as.character(cda_system$L3[28]), as.character(cda_system$L4[28]), as.character(cda_system$L5[28])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[29]), radioButtons("org71q16", label = h4(cda_system$Pertanyaan[29]), choiceNames = list(as.character(cda_system$L1[29]), as.character(cda_system$L2[29]), as.character(cda_system$L3[29]), as.character(cda_system$L4[29]), as.character(cda_system$L5[29])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[30]), radioButtons("org71q17", label = h4(cda_system$Pertanyaan[30]), choiceNames = list(as.character(cda_system$L1[30]), as.character(cda_system$L2[30]), as.character(cda_system$L3[30]), as.character(cda_system$L4[30]), as.character(cda_system$L5[30])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[31]), radioButtons("org71q18", label = h4(cda_system$Pertanyaan[31]), choiceNames = list(as.character(cda_system$L1[31]), as.character(cda_system$L2[31]), as.character(cda_system$L3[31]), as.character(cda_system$L4[31]), as.character(cda_system$L5[31])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),  
      h3(cda_system$Indikator[32]), radioButtons("org71q19", label = h4(cda_system$Pertanyaan[32]), choiceNames = list(as.character(cda_system$L1[32]), as.character(cda_system$L2[32]), as.character(cda_system$L3[32]), as.character(cda_system$L4[32]), as.character(cda_system$L5[32])), choiceValues = list(1, 2, 3, 4, 5), width = "100%")            
    ),
    tabItem(tabName = "sys72",
      h3(cda_system$Indikator[33]), radioButtons("org72q01", label = h4(cda_system$Pertanyaan[33]), choiceNames = list(as.character(cda_system$L1[33]), as.character(cda_system$L2[33]), as.character(cda_system$L3[33]), as.character(cda_system$L4[33]), as.character(cda_system$L5[33])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[34]), radioButtons("org72q02", label = h4(cda_system$Pertanyaan[34]), choiceNames = list(as.character(cda_system$L1[34]), as.character(cda_system$L2[34]), as.character(cda_system$L3[34]), as.character(cda_system$L4[34]), as.character(cda_system$L5[34])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[35]), radioButtons("org72q03", label = h4(cda_system$Pertanyaan[35]), choiceNames = list(as.character(cda_system$L1[35]), as.character(cda_system$L2[35]), as.character(cda_system$L3[35]), as.character(cda_system$L4[35]), as.character(cda_system$L5[35])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[36]), radioButtons("org72q04", label = h4(cda_system$Pertanyaan[36]), choiceNames = list(as.character(cda_system$L1[36]), as.character(cda_system$L2[36]), as.character(cda_system$L3[36]), as.character(cda_system$L4[36]), as.character(cda_system$L5[36])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[37]), radioButtons("org72q05", label = h4(cda_system$Pertanyaan[37]), choiceNames = list(as.character(cda_system$L1[37]), as.character(cda_system$L2[37]), as.character(cda_system$L3[37]), as.character(cda_system$L4[37]), as.character(cda_system$L5[37])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[38]), radioButtons("org72q06", label = h4(cda_system$Pertanyaan[38]), choiceNames = list(as.character(cda_system$L1[38]), as.character(cda_system$L2[38]), as.character(cda_system$L3[38]), as.character(cda_system$L4[38]), as.character(cda_system$L5[38])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[39]), radioButtons("org72q07", label = h4(cda_system$Pertanyaan[39]), choiceNames = list(as.character(cda_system$L1[39]), as.character(cda_system$L2[39]), as.character(cda_system$L3[39]), as.character(cda_system$L4[39]), as.character(cda_system$L5[39])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[40]), radioButtons("org72q08", label = h4(cda_system$Pertanyaan[40]), choiceNames = list(as.character(cda_system$L1[40]), as.character(cda_system$L2[40]), as.character(cda_system$L3[40]), as.character(cda_system$L4[40]), as.character(cda_system$L5[40])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[41]), radioButtons("org72q09", label = h4(cda_system$Pertanyaan[41]), choiceNames = list(as.character(cda_system$L1[41]), as.character(cda_system$L2[41]), as.character(cda_system$L3[41]), as.character(cda_system$L4[41]), as.character(cda_system$L5[41])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[42]), radioButtons("org72q10", label = h4(cda_system$Pertanyaan[42]), choiceNames = list(as.character(cda_system$L1[42]), as.character(cda_system$L2[42]), as.character(cda_system$L3[42]), as.character(cda_system$L4[42]), as.character(cda_system$L5[42])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[43]), radioButtons("org72q11", label = h4(cda_system$Pertanyaan[43]), choiceNames = list(as.character(cda_system$L1[43]), as.character(cda_system$L2[43]), as.character(cda_system$L3[43]), as.character(cda_system$L4[43]), as.character(cda_system$L5[43])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[44]), radioButtons("org72q12", label = h4(cda_system$Pertanyaan[44]), choiceNames = list(as.character(cda_system$L1[44]), as.character(cda_system$L2[44]), as.character(cda_system$L3[44]), as.character(cda_system$L4[44]), as.character(cda_system$L5[44])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[45]), radioButtons("org72q13", label = h4(cda_system$Pertanyaan[45]), choiceNames = list(as.character(cda_system$L1[45]), as.character(cda_system$L2[45]), as.character(cda_system$L3[45]), as.character(cda_system$L4[45]), as.character(cda_system$L5[45])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[46]), radioButtons("org72q14", label = h4(cda_system$Pertanyaan[46]), choiceNames = list(as.character(cda_system$L1[46]), as.character(cda_system$L2[46]), as.character(cda_system$L3[46]), as.character(cda_system$L4[46]), as.character(cda_system$L5[46])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[47]), radioButtons("org72q15", label = h4(cda_system$Pertanyaan[47]), choiceNames = list(as.character(cda_system$L1[47]), as.character(cda_system$L2[47]), as.character(cda_system$L3[47]), as.character(cda_system$L4[47]), as.character(cda_system$L5[47])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[48]), radioButtons("org72q16", label = h4(cda_system$Pertanyaan[48]), choiceNames = list(as.character(cda_system$L1[48]), as.character(cda_system$L2[48]), as.character(cda_system$L3[48]), as.character(cda_system$L4[48]), as.character(cda_system$L5[48])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[49]), radioButtons("org72q17", label = h4(cda_system$Pertanyaan[49]), choiceNames = list(as.character(cda_system$L1[49]), as.character(cda_system$L2[49]), as.character(cda_system$L3[49]), as.character(cda_system$L4[49]), as.character(cda_system$L5[49])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_system$Indikator[50]), radioButtons("org72q18", label = h4(cda_system$Pertanyaan[50]), choiceNames = list(as.character(cda_system$L1[50]), as.character(cda_system$L2[50]), as.character(cda_system$L3[50]), as.character(cda_system$L4[50]), as.character(cda_system$L5[50])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),  
      h3(cda_system$Indikator[51]), radioButtons("org72q19", label = h4(cda_system$Pertanyaan[51]), choiceNames = list(as.character(cda_system$L1[51]), as.character(cda_system$L2[51]), as.character(cda_system$L3[51]), as.character(cda_system$L4[51]), as.character(cda_system$L5[51])), choiceValues = list(1, 2, 3, 4, 5), width = "100%")
    ),
    ...
    tabItem(tabName = "ind61", 
      ...
      h3(cda_organisation$Indikator[5]),
      radioButtons("ind61q01", label = h4(cda_individu$Pertanyaan[1]), choiceNames = list(as.character(cda_system$L1[1]), as.character(cda_system$L2[1]), as.character(cda_system$L3[1]), as.character(cda_system$L4[1]), as.character(cda_system$L5[1])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[2]),
      h3(cda_organisation$Indikator[5]),
      radioButtons("ind61q02", label = h4(cda_individu$Pertanyaan[2]), choiceNames = list(as.character(cda_system$L1[2]), as.character(cda_system$L2[2]), as.character(cda_system$L3[2]), as.character(cda_system$L4[2]), as.character(cda_system$L5[2])), choiceValues = list(1, 2, 3, 4, 5), width = "100%")
    ),
    tabItem(tabName = "ind62",
      h3(cda_individu$Indikator[3]),
      radioButtons("ind62q01", label = h4(cda_individu$Pertanyaan[3]), choiceNames = list(as.character(cda_system$L1[3]), as.character(cda_system$L2[3]), as.character(cda_system$L3[3]), as.character(cda_system$L4[3]), as.character(cda_system$L5[3])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[4]),
      radioButtons("ind62q02", label = h4(cda_individu$Pertanyaan[4]), choiceNames = list(as.character(cda_system$L1[4]), as.character(cda_system$L2[4]), as.character(cda_system$L3[4]), as.character(cda_system$L4[4]), as.character(cda_system$L5[4])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[5]),
      radioButtons("ind62q03", label = h4(cda_individu$Pertanyaan[5]), choiceNames = list(as.character(cda_system$L1[5]), as.character(cda_system$L2[5]), as.character(cda_system$L3[5]), as.character(cda_system$L4[5]), as.character(cda_system$L5[5])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[6]),
      radioButtons("ind62q04", label = h4(cda_individu$Pertanyaan[6]), choiceNames = list(as.character(cda_system$L1[6]), as.character(cda_system$L2[6]), as.character(cda_system$L3[6]), as.character(cda_system$L4[6]), as.character(cda_system$L5[6])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[7]),
      radioButtons("ind62q05", label = h4(cda_individu$Pertanyaan[7]), choiceNames = list(as.character(cda_system$L1[7]), as.character(cda_system$L2[7]), as.character(cda_system$L3[7]), as.character(cda_system$L4[7]), as.character(cda_system$L5[7])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[8]),
      radioButtons("ind62q06", label = h4(cda_individu$Pertanyaan[8]), choiceNames = list(as.character(cda_system$L1[8]), as.character(cda_system$L2[8]), as.character(cda_system$L3[8]), as.character(cda_system$L4[8]), as.character(cda_system$L5[8])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[9]),
      radioButtons("ind62q07", label = h4(cda_individu$Pertanyaan[9]), choiceNames = list(as.character(cda_system$L1[9]), as.character(cda_system$L2[9]), as.character(cda_system$L3[9]), as.character(cda_system$L4[9]), as.character(cda_system$L5[9])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[10]),
      radioButtons("ind62q08", label = h4(cda_individu$Pertanyaan[10]), choiceNames = list(as.character(cda_system$L1[10]), as.character(cda_system$L2[10]), as.character(cda_system$L3[10]), as.character(cda_system$L4[10]), as.character(cda_system$L5[10])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[11]),
      radioButtons("ind62q09", label = h4(cda_individu$Pertanyaan[11]), choiceNames = list(as.character(cda_system$L1[11]), as.character(cda_system$L2[11]), as.character(cda_system$L3[11]), as.character(cda_system$L4[11]), as.character(cda_system$L5[11])), choiceValues = list(1, 2, 3, 4, 5), width = "100%")
    ),
    tabItem(tabName = "ind63",
      h3(cda_individu$Indikator[12]),
      radioButtons("ind63q01", label = h4(cda_individu$Pertanyaan[12]), choiceNames = list(as.character(cda_system$L1[12]), as.character(cda_system$L2[12]), as.character(cda_system$L3[12]), as.character(cda_system$L4[12]), as.character(cda_system$L5[12])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[13]),
      radioButtons("ind63q02", label = h4(cda_individu$Pertanyaan[13]), choiceNames = list(as.character(cda_system$L1[13]), as.character(cda_system$L2[13]), as.character(cda_system$L3[13]), as.character(cda_system$L4[13]), as.character(cda_system$L5[13])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[14]),
      radioButtons("ind63q03", label = h4(cda_individu$Pertanyaan[14]), choiceNames = list(as.character(cda_system$L1[14]), as.character(cda_system$L2[14]), as.character(cda_system$L3[14]), as.character(cda_system$L4[14]), as.character(cda_system$L5[14])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[15]),
      radioButtons("ind63q04", label = h4(cda_individu$Pertanyaan[15]), choiceNames = list(as.character(cda_system$L1[15]), as.character(cda_system$L2[15]), as.character(cda_system$L3[15]), as.character(cda_system$L4[15]), as.character(cda_system$L5[15])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[16]),
      radioButtons("ind63q05", label = h4(cda_individu$Pertanyaan[16]), choiceNames = list(as.character(cda_system$L1[16]), as.character(cda_system$L2[16]), as.character(cda_system$L3[16]), as.character(cda_system$L4[16]), as.character(cda_system$L5[16])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[17]),
      radioButtons("ind63q06", label = h4(cda_individu$Pertanyaan[17]), choiceNames = list(as.character(cda_system$L1[17]), as.character(cda_system$L2[17]), as.character(cda_system$L3[17]), as.character(cda_system$L4[17]), as.character(cda_system$L5[17])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[18]),
      radioButtons("ind63q07", label = h4(cda_individu$Pertanyaan[18]), choiceNames = list(as.character(cda_system$L1[18]), as.character(cda_system$L2[18]), as.character(cda_system$L3[18]), as.character(cda_system$L4[18]), as.character(cda_system$L5[18])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[19]),
      radioButtons("ind63q08", label = h4(cda_individu$Pertanyaan[19]), choiceNames = list(as.character(cda_system$L1[19]), as.character(cda_system$L2[19]), as.character(cda_system$L3[19]), as.character(cda_system$L4[19]), as.character(cda_system$L5[19])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[20]),
      radioButtons("ind63q09", label = h4(cda_individu$Pertanyaan[20]), choiceNames = list(as.character(cda_system$L1[20]), as.character(cda_system$L2[20]), as.character(cda_system$L3[20]), as.character(cda_system$L4[20]), as.character(cda_system$L5[20])), choiceValues = list(1, 2, 3, 4, 5), width = "100%")
    ),
    tabItem(tabName = "ind64",
      h3(cda_individu$Indikator[21]),
      radioButtons("ind64q01", label = h4(cda_individu$Pertanyaan[21]), choiceNames = list(as.character(cda_system$L1[21]), as.character(cda_system$L2[21]), as.character(cda_system$L3[21]), as.character(cda_system$L4[21]), as.character(cda_system$L5[21])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[22]),
      radioButtons("ind64q02", label = h4(cda_individu$Pertanyaan[22]), choiceNames = list(as.character(cda_system$L1[22]), as.character(cda_system$L2[22]), as.character(cda_system$L3[22]), as.character(cda_system$L4[22]), as.character(cda_system$L5[22])), choiceValues = list(1, 2, 3, 4, 5), width = "100%"),
      h3(cda_individu$Indikator[23]),
      radioButtons("ind64q03", label = h4(cda_individu$Pertanyaan[23]), choiceNames = list(as.character(cda_system$L1[23]), as.character(cda_system$L2[23]), as.character(cda_system$L3[23]), as.character(cda_system$L4[23]), as.character(cda_system$L5[23])), choiceValues = list(1, 2, 3, 4, 5), width = "100%")
    ),
