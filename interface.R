...
dashboardPage(
  ...
  sidebar = dashboardSidebar(width = "500px",
    sidebarMenu(
      ...
      menuItem("Summary",# icon = icon("random"), 
  ...
  body = dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "profil",
        selectInput("prov", "Provinsi", choices=provinces),
        textInput("nama", "Nama", value="", width=NULL, placeholder=""),
        textInput("institusi", "Institusi", value="", width=NULL, placeholder=""),
        textInput("posisi", "Posisi", value="", width=NULL, placeholder=""),
        textInput("jabatan", "Jabatan", value="", width=NULL, placeholder="")
      ),
      ###*tab-system####=
