...
ui <- fluidPage(
  ...
  navbarPage("", theme = shinytheme("lumen"),
             tabPanel("Nasional", fluid = TRUE, icon = icon("globe"),
                      ...
                      #     radioButtons(inputId = "AspekID",
                      #                  label = "Pilih Aspek:",
                      #                  choices = c("Regulasi/peraturan daerah","Integrasi dalam Perencanaan Pembangunan Daerah", "Proses", "Data dan Informasi", "Pemantauan, Evaluasi, dan Pelaporan","Organisasi","Sumber Daya Manusia - Organisasi", "Teknologi", "Sumber Daya Manusia - Individu","Rata-rata"),
                      #                  selected = "Regulasi/peraturan daerah"),
                      #     # Select which Region(s) to plot
                      #     checkboxGroupInput(inputId = "RegionDI",
                      #                        label = "Pilih Regional:",
                      #                        # choices = c("Aceh", "Bangka Belitung", "Bengkulu", "Jambi", "Kepulauan Riau", "Lampung", "Riau", "Sumatera Barat", "Sumatera Selatan", "Sumatera Utara",
                      #                        #             "Bali", "Banten", "Jawa Barat", "Jawa Tengah", "Jawa Timur", "Kalimantan Barat", "Kalimantan Selatan", "Kalimantan Tengah", "Kalimantan Timur", "Nusa Tenggara Barat", "Nusa Tenggara Timur", "Yogyakarta",
                      #                        #             "Gorontalo", "Maluku", "Maluku Utara", "Papua", "Papua Barat", "Sulawesi Selatan", "Sulawesi Tengah", "Sulawesi Tenggara", "Sulawesi Barat", "Sulawesi Utara"),
                      #                        choices = list(`Barat` = list("Aceh", "Bangka Belitung", "Bengkulu", "Jambi", "Kepulauan Riau",
                      ...
                      #   ),
                      #   mainPanel(
                      #     h2(textOutput(outputId = "titleSistem")),
                      #     withSpinner(plotlyOutput(outputId = "resChartSys"))
                      #   )
                      # )
             )
  ),
